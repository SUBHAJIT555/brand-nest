...
$allowed = array(
    'https://brand-nest.com',
    'https://www.brand-nest.com',
    'http://brand-nest.com',
    'http://www.brand-nest.com',
    'http://localhost:3000',
    'http://localhost:5173',
);
...
$brandName = 'Brand Nest';
$tagline = "India's trusted store for electronics, books, stationery, and garments.";
$brandColor = '#FF0000';
$border = '#e5e7eb';
$toEmail = 'info@brand-nest.com';

if ($formType === 'contact') {
    $subject = 'New Contact Inquiry - Brand Nest - ' . $name;
} elseif ($formType === 'newsletter') {
    $subject = 'New Newsletter Signup - Brand Nest - ' . $email;
} elseif ($formType === 'quote') {
    $subject = 'New Quote Request - Brand Nest - ' . $name;
} else {
    $subject = 'Form Submission - Brand Nest';
}
