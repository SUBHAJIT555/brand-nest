...
export const metadata: Metadata = {
  ...
  description: "Brand Nest is India's trusted store for electronics, books, stationery, and garments. Honest prices, fast delivery, and support for Indian shoppers.",
};
