...
const Header = () => {
  ...
  return (
    ...
    >
              ...
              <form onSubmit={handleSearchSubmit} className="header-search-form">
                <div className="flex items-center">
                  ...
                  <div className="relative max-w-[333px] sm:min-w-[333px] w-full">
                    <span className="absolute left-0 top-1/2 -translate-y-1/2 inline-block w-px h-5 bg-gray-200" aria-hidden />
                    <input
                      ...
                      autoComplete="off"
                      className="custom-search w-full rounded-r-xl bg-gray-50 border-l-0 border border-gray-200 py-2.5 pl-4 pr-10 outline-none transition-colors focus:border-[#FF0000] focus:ring-2 focus:ring-[#FF0000]/10"
                    />
                    ...
                    <button
                      ...
                      id="search-btn"
                      aria-label="Search"
                      className="flex items-center justify-center absolute right-3 top-1/2 -translate-y-1/2 text-dark-4 hover:text-[#FF0000] transition-colors"
                    >
                      <svg
                    ...
                    {showSearchResults && searchResults.length > 0 && (
                      <div className="absolute top-full left-0 right-0 mt-1.5 bg-white border border-gray-200 rounded-xl shadow-lg z-9999 max-h-[400px] overflow-y-auto">
                        <div className="p-2">
                          {searchResults.map((product) => (
                            <div
                              key={product.id}
                              onClick={() => handleProductClick(product.id)}
                              className="flex items-center gap-3 p-2.5 hover:bg-[#FF0000]/5 rounded-lg cursor-pointer transition-colors"
                            >
          ...
          <div className="flex w-full lg:w-auto items-center gap-7.5">
            ...
            <div className="flex w-full lg:w-auto justify-between items-center gap-5">
              <div className="flex items-center gap-5">
                ...
                >
                  <span className="inline-block relative">
                    ...
                    <span className="flex items-center justify-center font-semibold text-2xs absolute -right-2 -top-2.5 bg-[#FF0000] w-5 h-5 rounded-full text-white min-w-[20px]">
                      {product.length}
                    </span>
                  </span>
              ...
              <button
                ...
                className="xl:hidden flex items-center justify-center w-10 h-10 rounded-xl border-2 border-gray-200 bg-white hover:border-[#FF0000] hover:bg-[#FF0000]/5 text-dark transition-colors"
      ...
      <div className="border-t border-gray-100 bg-[#FAF9F7]/50">
        <div className="max-w-[1170px] mx-auto px-4 sm:px-7.5 xl:px-0">
          <div className="flex items-center justify-between">
            <div
              className={`w-[288px] absolute right-4 top-full xl:static xl:w-auto h-0 xl:h-auto invisible xl:visible xl:flex items-center justify-between ${navigationOpen &&
                `!visible bg-white shadow-xl border border-gray-200 !h-auto max-h-[400px] overflow-y-scroll rounded-xl p-5`
                }`}
            >
              {/* <!-- Main Nav Start --> */}
              <nav>
                <ul className="flex xl:items-center flex-col xl:flex-row gap-5 xl:gap-6">
                  {menuData.map((menuItem, i) =>
                    menuItem.submenu ? (
                      ...
                      <li
                        key={i}
                        className="group relative before:w-0 before:h-0.5 before:bg-[#FF0000] before:absolute before:left-0 before:bottom-0 before:rounded-full before:ease-out before:duration-200 hover:before:w-full"
                      >
                        <Link
                          href={menuItem.path}
                          className={`hover:text-[#FF0000] text-custom-sm font-medium text-dark flex ${stickyMenu ? "xl:py-4" : "xl:py-5"
                            }`}
                        >
                          {menuItem.title}
                        </Link>
            ...
            <div className="hidden xl:block">
              <ul className="flex items-center gap-5.5">
                ...
                <li className="py-4">
                  <Link
                    href="/wishlist"
                    className="flex items-center gap-1.5 font-medium text-custom-sm text-dark hover:text-[#FF0000] transition-colors"
                  >
                    <svg
                      className="fill-current"
                      width="16"
