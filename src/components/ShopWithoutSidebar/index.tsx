              ...
              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                <div className="flex flex-wrap items-center gap-4">
                  ...
                  <span className="inline-flex items-center rounded-lg bg-[#FF0000]/5 text-dark-2 px-3 py-2 text-sm font-medium border border-[#FF0000]/10">
                    <span className="font-bold text-[#FF0000]">{filteredProducts.length}</span>
                ...
                <div className="flex items-center gap-1 p-1 rounded-xl bg-gray-100/80 w-fit">
                    <button
                      ...
                      className={`${productStyle === "grid"
                        ? "bg-white text-[#FF0000] shadow-sm border border-gray-200"
                        : "text-dark-3 hover:text-dark"
                        } flex items-center justify-center w-10 h-9 rounded-lg border border-transparent ease-out duration-200 hover:bg-white hover:text-[#FF0000]`}
                    >
                      <svg
