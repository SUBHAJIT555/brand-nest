  ...
  return (
    <>
      <Breadcrumb
        ...
        pages={["shop",]}
      />
      <section className="overflow-hidden relative pb-20 pt-5 lg:pt-20 xl:pt-28 bg-[#FAF9F7]">
        <div className="max-w-[1200px] w-full mx-auto px-4 sm:px-8 xl:px-6">
          <div className="flex gap-8">
            {/* Sidebar: card style on desktop, drawer on mobile */}
            <div
              className={`sidebar-content fixed xl:z-1 z-9999 left-0 top-0 xl:translate-x-0 xl:static max-w-[310px] xl:max-w-[260px] w-full ease-out duration-200 ${productSidebar
                ? "translate-x-0 h-screen overflow-y-auto bg-white shadow-2xl"
                : "-translate-x-full"
                } xl:rounded-2xl xl:bg-white xl:shadow-lg xl:border xl:border-gray-100 xl:p-5 xl:h-fit xl:sticky xl:top-28`}
            >
              <div className="xl:hidden sticky top-0 z-10 flex items-center justify-between bg-white border-b border-gray-100 px-5 py-4">
                <span className="text-lg font-bold text-dark flex items-center gap-2">
                  <span className="w-1 h-6 rounded-full bg-[#FF0000]" />
                  Filters
                </span>
                <button
                  onClick={() => setProductSidebar(false)}
                  aria-label="Close filters"
                  className="p-2 rounded-xl hover:bg-gray-100 text-dark transition-colors"
                >
              ...
              <button
                ...
                className={`xl:hidden absolute -right-12.5 sm:-right-8 flex items-center justify-center w-11 h-11 rounded-xl bg-[#FF0000] text-white shadow-lg hover:bg-[#CC0000] transition-all duration-200 ${stickyMenu
              ...
              <form onSubmit={(e) => e.preventDefault()} className="p-5 xl:p-0">
                <div className="flex flex-col gap-5">
                  <div className="hidden xl:flex items-center justify-between">
                    <p className="font-bold text-dark flex items-center gap-2">
                      <span className="w-1 h-5 rounded-full bg-[#FF0000]" />
                      Filters
                    </p>
                    <button
                      onClick={handleClearFilters}
                      className="text-[#FF0000] text-sm font-semibold hover:text-[#CC0000] transition-colors"
                    >
                      Clear All
                    </button>
                  </div>
            ...
            <div className="flex-1 min-w-0 max-w-full">
              <div className="rounded-2xl bg-white shadow-md border border-gray-100 px-4 sm:px-6 py-4 mb-8">
                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                  <div className="flex flex-wrap items-center gap-3 sm:gap-4">
                    ...
                    />
                    <span className="inline-flex items-center rounded-lg bg-[#FF0000]/5 text-dark-2 px-3 py-2 text-sm font-medium border border-[#FF0000]/10">
                      <span className="font-bold text-[#FF0000]">{startIndex + 1}–{Math.min(endIndex, filteredProducts.length)}</span>
                  ...
                  <div className="flex items-center gap-1 p-1 rounded-xl bg-gray-100/80 w-fit">
                    <button
                      ...
                      className={`${productStyle === "grid"
                        ...
                        } flex items-center justify-center w-10 h-9 rounded-lg ease-out duration-200`}
                    >
                      <svg
                        className="fill-current"
                        width="18"
              ...
              {totalPages > 1 && (
                <div className="flex justify-center mt-14">
                  <nav className="inline-flex items-center gap-1 p-1.5 bg-white border border-gray-100 rounded-2xl shadow-md" aria-label="Pagination">
                    <ul className="flex items-center gap-1">
                      <li>
                        <button
                          ...
                          className={`flex items-center justify-center w-9 h-9 ease-out duration-200 rounded-lg ${currentPage === 1
                            ? "text-gray-400 cursor-not-allowed"
                            : "hover:text-white hover:bg-[#FF0000] text-dark"
                            }`}
                        >
                          <svg
                            className="fill-current"
                      ...
                      {getPageNumbers().map((page, index) => (
                        <li key={index}>
                          {page === '...' ? (
                            <span className="flex py-1.5 px-3.5 duration-200 rounded-lg text-dark">
                              ...
                            </span>
                          ) : (
                            <button
                              onClick={() => handlePageChange(page as number)}
                              className={`flex min-w-[2.25rem] h-9 items-center justify-center px-3.5 duration-200 rounded-lg ${currentPage === page
                      ...
                      <li>
                        <button
                          ...
                          className={`flex items-center justify-center w-9 h-9 ease-out duration-200 rounded-lg ${currentPage === totalPages
                            ? "text-gray-400 cursor-not-allowed"
                            : "hover:text-white hover:bg-[#FF0000] text-dark"
                            }`}
                        >
