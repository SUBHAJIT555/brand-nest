  ...
  return (
    <div className="group">
      <div className="relative overflow-hidden flex items-center justify-center rounded-xl border border-gray-200/80 bg-gray-50/50 min-h-[270px] mb-4 shadow-sm transition-all duration-300 hover:shadow-md hover:border-[#FF0000]/25">
        <Link href="/shop" className="absolute inset-0 z-0 flex items-center justify-center" onClick={(e) => { e.preventDefault(); handleProductDetails(); }}>
          <Image
            src={item.img}
            alt={item.title}
            width={250}
      ...
      <Link href="/shop" onClick={() => handleProductDetails()}>
